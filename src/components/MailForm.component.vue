...
export default Vue.extend({
  props: {
    ...
    makeUserLink: Function as PropType<(id: string) => Promise<string>>,
  },
  data: function () {
    return {
      mail: "",
